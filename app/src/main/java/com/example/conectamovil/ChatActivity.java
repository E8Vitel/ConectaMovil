...
import com.example.conectamovil.Adaptador.MensajeAdapter;
import com.example.conectamovil.Entidades.Mensaje;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mqttHelper.connect(URL_BROKER, ID_CLIENTE);
        ...
        enviarBoton = findViewById(R.id.btnEnviarMensaje);
        mensajeText = findViewById(R.id.inputMensaje);
        ...
        mqttHelper.setMessageCallback(new MqttHelper.MqttMessageCallback() {
            @Override
                        ...
                        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()) {
                                    ...
                                    Toast.makeText(ChatActivity.this, "No se encontraron datos de usuario", Toast.LENGTH_SHORT).show();
                                }
                            }
    ...
    private void publicMessage(String topico, String mensaje) {
        ...
        mqttHelper.publish(topico, mensaje);
    }
